...
class TestDemandEndpoints:
    ...
    def test_stable_demand_items_have_small_changes(self, client):
        ...
        # The fixture keeps at least one stable item so this check is meaningful
    ...
    def test_demand_forecast_skus_exist_in_inventory(self, client):
        """Every forecast must reference a real inventory SKU.

        Restocking recommendations price forecasts with the inventory unit
        cost, so a forecast for an unknown SKU would silently drop out.
        """
